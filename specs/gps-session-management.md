...
- 車両選択、メーター距離入力、将来の燃費管理の前提は [specs/vehicle-fuel-management.md](specs/vehicle-fuel-management.md) で定義する。
...
- 現在地追従や現在地へ戻す操作でアプリ側が行うカメラ更新に伴う region change 通知だけでは、手動操作扱いにせず、自動追従解除や現在地へ戻すアイコン表示を起こさない。
